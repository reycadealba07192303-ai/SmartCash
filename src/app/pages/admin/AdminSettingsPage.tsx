...
const AdminSettingsPage: React.FC = () => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setProfile({
                        ...
                        email: data.email || '',
                        role: data.role ? (data.role.charAt(0).toUpperCase() + data.role.slice(1)) : 'Administrator',
                        avatar: data.avatar_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(data.full_name || 'Admin')}&background=10b981&color=fff`
                    });
                }
            } catch (error) {
    ...
    const handlePasswordSave = () => {
        ...
        setSuccessMessage('Password updated successfully! Please check your email for confirmation.');
        setShowSuccessModal(true);
    };
